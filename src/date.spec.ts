...
describe('DateTime', () => {
  ...
  it('should determine if multiple DateTimes are in the same date', () => {
    ...
    expect(dateTime1.isInSameDates(dateTime2, dateTime3)).toBe(false);
    expect(dateTime1.isInSameDate(dateTime3)).toBe(false);
    expect(dateTime1.isInSameDate(dateTime2)).toBe(true);
    expect(dateTime1.isInSameDates(dateTime3)).toBe(false);
    expect(dateTime1.isInSameDates(dateTime2)).toBe(true);
  });
});
